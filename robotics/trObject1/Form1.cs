...
namespace trObject1
{
    public partial class Form1 : Form
    {
        ...
        public void DoCommands()
        {
            ...
            int i;
            // First if statement to check for abort.
            if (!abort)
            {
                sp.Write("8");
                i = 8;
            ...
            // Second if statement to check for abort.
            ...
            if (!abort)
            {
                ...
                Thread.Sleep(2000);
                bgw.ReportProgress(i);
                // textBox.Text += (Environment.NewLine + "Forward" + Environment.NewLine);
            ...
            // Third if statement to check for abort.
            ...
            // Fourth if statement to check for abort.
            if (!abort)
            {
            ...
            // Fifth if statement to check for abort.
            if (!abort)
            {
            ...
            // sixth if statement to check for abort.
            if (!abort)
            {
                sp.Write("6");
                i = 6;
            ...
            // Ninth if statement to check for abort.
            if (!abort)
            {

                MessageBox.Show("Mission Accomplished Target Detected", "Status");
                i = 12;
                bgw.ReportProgress(i);
                // For progressBar at the end of each if loop:
                bgw.ReportProgress(101);
